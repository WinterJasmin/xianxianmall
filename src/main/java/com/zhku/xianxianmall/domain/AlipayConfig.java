...
public class AlipayConfig {
     ...
     **/
    public static String app_id = "2016091900548206";
     ...
     **/
    public static String notify_url = "http://39.108.177.62:8080/xianxianmall/order/notify_url";

    /**39.108.177.62
     * 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
     **/
    public static String return_url = "http://39.108.177.62:8080/xianxianmall/order/return_url";
